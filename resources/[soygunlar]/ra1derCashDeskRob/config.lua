...
cashdeskrob.TimeInDesk = math.random(20000, 25000) -- her bir veznenin arama süresi(ms)
cashdeskrob.CloseDoorWhenFinish = 50000 -- soygunu bitirdikten sonra kapının kapanması süresi(ms) 50 saniye
cashdeskrob.NeedCop = 3 -- soygun için gerekli polis sayısı
cashdeskrob.time = 3600 --1 saat | saniye sonra tekrar soyulabilir
