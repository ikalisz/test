    ...
    $.post("https://qb-inventoryv2/GetWeaponData", JSON.stringify({
        ...
        if (data.AttachmentData !== null && data.AttachmentData !== undefined) {
            if (data.AttachmentData.length > 0) {
                $(".weapon-attachments-title").html('<span style="font-weight: bold; letter-spacing: .1vh;">Additions</span>');
                ...
                $(".weapon-attachments-title").html('<span style="font-weight: bold; letter-spacing: .1vh;">No Attachment On Weapon</span>');
            }
        } else {
            $(".weapon-attachments-title").html('<span style="font-weight: bold; letter-spacing: .1vh;">No Attachment On Weapon</span>');
        }
...
$(document).on('click', '#weapon-attachments', function(e){
    ...
    if (!Inventory.IsWeaponBlockedA(ClickedItemData.name)) {
        ...
        $.post('https://qb-inventoryv2/Notify', JSON.stringify({
            message: "Bu Silahın Additionsini Düzenleyemezsin",
            type: "error"
        }))
    }
});
    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.type == "weapon") {
            ...
            if (itemData.info.attachments != null) {
                ...
                $(".item-info-description").html('<p><strong>Total weight: </strong><span>' + ((itemData.weight * itemData.amount) / 1000).toFixed(1) + 'kg</span></p><p><strong>Serial number: </strong><span>' + itemData.info.serie +  '</span></p><p><strong>Robustness: </strong><span>' + durubality + '%</span></p><p><strong>Additions: </strong><span>' + attachmentString + '</span></p><p>' + itemData.description + '</p>');
            } else{
                $(".item-info-description").html('<p><strong>Total weight: </strong><span>' + ((itemData.weight * itemData.amount) / 1000).toFixed(1) + 'kg</span></p><p><strong>Serial number: </strong><span>' + itemData.info.serie + '</span></p><p><strong>Robustness: </strong><span>' + durubality + '%</span></p><p>' + itemData.description + '</p>');
            }

            if (itemData.info.costs != undefined && itemData.info.costs != null) {
                $(".item-info-title").html('<p>'+itemData.label+'</p>')
                $(".item-info-description").html('<p><strong>Total weight: </strong><span>' + ((itemData.weight * itemData.amount) / 1000).toFixed(1) + 'kg</span></p><p>'+ itemData.info.costs + '</p>');
            }
            ...
            $(".item-info-description").html(
                "<p><strong>Identification number: </strong><span>" +
                ...
                gender +
                "</span></p><p><strong>Nation: </strong><span>" +
        ...
        $(".item-info-title").html("<p>" + itemData.label + "</p>");
        $(".item-info-description").html(
            "</span></p><p><strong>Bag Label: </strong><span>" +
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>Rank: </strong><span>" +
            ...
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html("</span></p><p><strong>Remaining Cigarettes: </strong><span>"+itemData.info.sigara+"</span></p>");
            ...
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Total weight: </strong><span>' + ((itemData.weight * itemData.amount) / 1000).toFixed(1) + 'kg</span></p><p><strong>Family: </strong><span>' + itemData.info.aile + '</span></p><p><strong>Engagement Date: </strong><span>' + itemData.info.tarih + '</span></p>');
            ...
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>Total weight: </strong><span>' + ((itemData.weight * itemData.amount) / 1000).toFixed(1) + 'kg</span></p><p><strong>Freshness: </strong><span>' + durubality + '%</span></p><p>' + itemData.description + '</p>')
        } 
        else {
...
function defaultDescription(itemData) {
    ...
    $(".item-info-description").html('<p><strong>Total weight: </strong><span>' + ((itemData.weight * itemData.amount) / 1000).toFixed(1) + 'kg</span></p><p>' + itemData.description + '</p>')
}
...
Inventory.Open = function(data) {
    ...
    $("#player-inv-label").html("<i class='bi bi-person-square'></i>"+" "+data.firstname+" "+data.lastname+" - "+"<i class='fas fa-money-bill-alt' style='color: green; font-style: normal;'></i>"+"<i style='color: green; font-style: normal;'>"+" "+data.para+"</i>")
    totalWeight = 0;
    totalWeightOther = 0;
    inventoryOpen = true;
    ...
    if (data.toggle) {
        if (!requiredItemOpen) {
            ...
            $.each(data.items, function(index, item){
                var element = '<div class="requiredItem-box"><div id="requiredItem-action">[E] Use (Need)</div><div id="requiredItem-image"><div class="item-slot-img"><img src="images/' + item.image + '" /></div></div></div>'
