    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            if (data.toggle) {
                ...
                var originalText = "Getting player data..";
                ...
                var DotsInterval = setInterval(function() {
                    ...
                    if (loadingProgress == 3) {
                        originalText = "Verifying player data.."
                        $("#loading-text").html(originalText);
                    }
                    if (loadingProgress == 4) {
                        originalText = "Getting player data.."
                        $("#loading-text").html(originalText);
                    }
...
function setupCharInfo(cData) {
    if (cData == 'empty') {
        ...
        '<div class="character-info-box"><span id="info-label"><i class="bi bi-person-lines-fill"></i> Name: </span><span class="char-info-js">'+cData.charinfo.firstname+' '+cData.charinfo.lastname+'</span></div>' +
        '<div class="character-info-box"><span id="info-label"><i class="bi bi-chat-right-text-fill"></i> Date of birth: </span><span class="char-info-js">'+cData.charinfo.birthdate+'</span></div>' +
        '<div class="character-info-box"><span id="info-label"><i class="bi bi-gender-ambiguous"></i> Gender: </span><span class="char-info-js">'+gender+'</span></div>' +
        '<div class="character-info-box"><span id="info-label"><i class="bi bi-globe"></i> Nationality: </span><span class="char-info-js">'+cData.charinfo.nationality+'</span></div>' +
        '<div class="character-info-box"><span id="info-label"><i class="bi bi-briefcase-fill"></i> Job: </span><span class="char-info-js">'+cData.job.label+'</span></div>' +
        '<div class="character-info-box"><span id="info-label"><i class="bi bi-cash-coin"></i> Cash Money: </span><span class="char-info-js">&#36; '+cData.money.cash+'</span></div>' +
        '<div class="character-info-box"><span id="info-label"><i class="bi bi-bank2"></i> Bank Money: </span><span class="char-info-js">&#36; '+cData.money.bank+'</span></div>' +
        '<div class="character-info-box"><span id="info-label"><i class="bi bi-phone-fill"></i> Phone Number: </span><span class="char-info-js">'+cData.charinfo.phone+'</span></div>' +
        '<div class="character-info-box"><span id="info-label"><i class="bi bi-person-rolodex"></i> Account Number: </span><span class="char-info-js">'+cData.charinfo.account+'</span></div>');
...
$(document).on('click', '.character', function(e) {
    ...
    if (selectedChar === null) {
        ...
        if ((selectedChar).data('cid') == "") {
            ...
            setupCharInfo('empty')
            $("#play-text").html('<i class="bi bi-cursor-fill"></i>'+' '+"Create Character");
            ...
            $("#play-text").html('<i class="bi bi-play"></i>'+' '+"Play");
            $("#delete-text").html('<i class="bi bi-trash"></i>'+' '+"Delete");
            $("#play").css({"display":"block"});
...
$(document).on('click', '#create', function (e) {
    ...
    if (!firstname || !lastname || !nationality || !birthdate || hasWhiteSpace(firstname) || hasWhiteSpace(lastname)|| hasWhiteSpace(nationality) ){
        $.post('https://qb-multicharacter/Notify', JSON.stringify({
...
function refreshCharacters() {
    $('.characters-list').html('<div class="character" id="char-1" data-cid=""><span id="slot-name">Empty Slot<span id="cid"></span></span></div><div class="character" id="char-2" data-cid=""><span id="slot-name">Boş Slot<span id="cid"></span></span></div><div class="character" id="char-3" data-cid=""><span id="slot-name">Boş Slot<span id="cid"></span></span></div><div class="character" id="char-4" data-cid=""><span id="slot-name">Boş Slot<span id="cid"></span></span></div><div class="character" id="char-5" data-cid=""><span id="slot-name">Boş Slot<span id="cid"></span></span></div><div class="character-btn" id="play"><p id="play-text">Select Character</p></div><div class="character-btn" id="delete"><p id="delete-text">Select Character</p></div>')
    setTimeout(function(){
        $(selectedChar).removeClass("char-selected");
        selectedChar = null;
        $.post('https://qb-multicharacter/setupCharacters');
