...
local spawns = {
    [1] = {coords = vector3(282.60, -619.21, 42.020), label = "Hospital"},
	[2] = {coords = vector3(1811.14, 3677.75, 34.27), label = "Sandy Shores"},
    [3] = {coords = vector3(-1833.96, -1223.5, 13.02), label = "Santa Monica Pier"},
    [4] = {coords = vector3(145.62, 6563.19, 32.0), label = "Paleto Gas Station"},
    [5] = {coords = vector3(477.981, -976.46, 27.98), label = "Mission Row PD"},
	[6] = {coords = vector3(-104.77, -1093.01, 26.12), label = "Gallery"},
	[7] = {coords = vector3(1852.95, 2585.95, 45.67), label = "Prison"},
}
...
AddEventHandler("qb-spawn:client:loadplayer", function(coords)
	...
	TriggerEvent("inventory:client:UpdatePlayerInventory") 
	TriggerEvent('tgiann-ambulance:check-death')
	TriggerServerEvent("qb-spawn:girislog")
end)
