...
function toggleSpectate(targetPed, targetPlayerId)
    ...
    if isSpectateEnabled then
        ...
        clearGamerTagInfo()
        DoScreenFadeIn(500)
        exports["elix1rBase"]:SendAlert('Spectate Deaktif :'..GetPlayerName(storedTargetPlayerId)..' ('..GetPlayerServerId(storedTargetPlayerId)..')')
        storedTargetPed = nil
    else
        ...
        DoScreenFadeIn(500)
        exports["elix1rBase"]:SendAlert('Spectate Aktif :'..GetPlayerName(storedTargetPlayerId)..' ('..GetPlayerServerId(storedTargetPlayerId)..')')
...
function cleanupFailedResolve()
    ...
    exports["elix1rBase"]:SendAlert('Spectate ended, the player not found!', 'error')
end
...
RegisterNetEvent('QBCore/client/specPlayer', function(targetServerId, coords)
    ...
    if targetPlayerId == PlayerId() then
        return exports["elix1rBase"]:SendAlert('How do you intend to watch yourself', 'error')
    end
