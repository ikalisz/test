...
RegisterNetEvent("Admin:OpenInv", function(Result)
    if IsPlayerAdmin() then
        ...
        exports["elix1rBase"]:SendAlert("" ..Result['player'].. "ID player's inventory opened")
    end
end)
...
RegisterNetEvent("mc-admin/client/toggle-godmode", function()
    ...
    exports["elix1rBase"]:SendAlert('Godmode '..Msg, MsgType)
...
RegisterNetEvent('mc-admin/client/UpdatePlayerBlips', function(BlipData)
    if not IsPlayerAdmin() then return end
