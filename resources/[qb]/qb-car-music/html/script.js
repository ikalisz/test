...
function getNameFile(url) {
	if (url == undefined) {
		vidname = "Çalan Şarkı Yok";
		document.getElementById("testrec").innerHTML = "<b>Çalıyor:</b><marquee direction = 'right'> "+ vidname + "</marquee>"
	} else {
