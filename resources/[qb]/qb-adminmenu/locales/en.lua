local Translations = {
    error = {
        ["blips_deactivated"] = "BLIPS disabled",
        ["names_deactivated"] = "User names are disabled",
        ["changed_perm_failed"] = "You should choose a perm!",
        ["missing_reason"] = "You should give a reason",
        ["invalid_reason_length_ban"] = "You should determine a reason and time to prohibit",
        ["no_store_vehicle_garage"] = "You cant store this vehicle in your garage..", 
        ["no_vehicle"] = "You are not in a vehicle..",
        ["no_weapon"] = "He has no guns in his hand, pampa",
        ["no_free_seats"] = "No empty seats in the vehicle baby",
        ["failed_vehicle_owner"] = "This tool is already yours",
        ["not_online"] = "The player is not online",
        ["no_receive_report"] = "There is no reports you can answer",
        ["failed_set_speed"] = "Don't you determine your speed (`fast` for super-run, `normal` for normal)",
        ["failed_set_model"] = "You need to write a model",
    },
    success = {
        ["blips_activated"] = "Blips Active",
        ["names_activated"] = "Names Active",
        ["coords_copied"] = "Coordinate copied",
        ["heading_copied"] = "Heading copied",
        ["changed_perm"] = "Perm changed",
        ["entered_vehicle"] = "Entered vehicle",
        ["success_vehicle_owner"] = "The vehicle is now yours!",
        ["receive_reports"] = "You got a report",
    },
    info = {
        ...
        ["model"] = "Model",
        ["hash"] = "Hash",
        ["eng_health"] = "Motor power:",
        ["body_health"] = "Body power:",
        ["goto"] = "Go next to it (Noclip should be opened)", 
        ["remove"] = "Decline",
        ["confirm"] = "Approve",
        ["reason_title"] = "Reason",
        ["length"] = "Length",
        ...
        ["reason"] = "You should enter a reason", 
        ["give"] = "Give",
        ["id"] = "ID:", 
        ["player_name"] = "Player name",
        ["delete_object_info"] = "To delete the object ~g~E", 
        ["obj"] = "Object",
        ["ammoforthe"] = "+%{value} Ammo for the %{weapon}", 
        ["kicked_server"] = "You were thrown out of the server",
        ["check_discord"] = "🔸 See Discord for more information: https://discord.gg/uRaaUPNKmd", 
        ["banned"] = "You are banned:",
        ["ban_perm"] = "\n\nThe prohibition is permanent.\n🔸 Come to Discord for more information: https://discord.gg/uRaaUPNKmd",
        ["ban_expires"] = "\n\nThe prohibition will end at: ",
        ["rank_level"] = "Your authority group ",
        ["admin_report"] = "Executive report - ",
        ["staffchat"] = "Authorized Chat - ",
