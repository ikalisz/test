const Targeting = Vue.createApp({
    data() {
        return {
            ...
            SuccessIcon: 'https://media.discordapp.net/attachments/1079436570320437248/1079436591468138607/eye.png', // Instead of icon it's using a image source found in HTML
            SuccessColor: "rgb(0, 119, 255)",
            StandardColor: "white",
            TargetHTML: "",
