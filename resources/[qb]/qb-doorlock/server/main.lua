...
local function isAuthorized(Player, door, usedLockpick)
	...
	if door.authorizedJobs then
		if door.authorizedJobs[Player.PlayerData.job.name] and Player.PlayerData.job.grade >= door.authorizedJobs[Player.PlayerData.job.name] then
			return true
	...
	-- 	if door.authorizedGangs[Player.PlayerData.gang.name] and Player.PlayerData.gang.grade >= door.authorizedGangs[Player.PlayerData.gang.name] then
	-- 		return true
