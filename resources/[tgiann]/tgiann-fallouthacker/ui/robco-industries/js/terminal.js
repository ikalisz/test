...
TogglePower = function()
{
	if (Power == "on") {
		...
		$("#terminal").html("");
		$.post('https://tgiann-falloutHacker/MenuKapatv2', JSON.stringify({basarili: null}));
		if (Sound) {
			$("#poweroff")[0].play();
		}
	} else {
...
Failure = function()
{
	...
	},
	{
		...
		complete : function()
		{
			$("#terminal").html("<div id='canvas'></div><div id='adminalert'><div class='character-hover alert-text' id = 'hatali'>HACK İŞLEMİ BAŞARISIZ DEVAM ETMEK İÇİN TIKLAYIN!</div></div>");
			...
			function hatali() {
				$.post('https://tgiann-falloutHacker/MenuKapat', JSON.stringify({basarili: false}));
				TogglePower()
			}
...
Success = function()
{
	...
	},
	{
		...
		complete : function()
		{
			...
			$("#terminal").html("<div id='canvas'></div><div id='adminalert'><div id='msg' class='character-hover alert-text'>HACK İŞLEMİ BAŞARILI</div><br /><div id='proceed' class='alert-text'>DEVAM ETMEK İÇİN TIKLAYIN!</div></div>");
			...
			document.getElementById("proceed").onclick = basarili;

			function basarili() {
				$.post('https://tgiann-fallouthacker/MenuKapat', JSON.stringify({basarili: true}));
				TogglePower()
			}
