...
Config.ImageUploading = { // Do not change index names, only the values.
    ...
    DiscordWebhooks: {
        Url: "https://discord.com/api/webhooks/961976594019282965/tkIBfstvZZ70o7-MiYDoHrSK9NbWw14SyrWjf9weq4ayQg9B2hoYMf4KRD_HhR4nWcxB", // Change this to your own discord webhook link.
...
Config.Applications = {
    ...
    "Ads": {
        label: "Ad Center",
        description: "Job and individual postings",
        icon: "fas fa-ad",
        icon_color: "#edce60",
        icon_image: "", 
        background: "#fff",
    ...
    "Garage": {
        label: "Garage",
        description: "Valet and garage information",
        icon: "fas fa-car",
        icon_color: "#000",
