...
QBCore.Functions.CreateCallback("high_phone:getVehicles", function(source, cb)
    ...
    if Player then
        ...
        MySQL.Async.fetchAll("SELECT * FROM owned_vehicles WHERE citizenid = @citizenid", {
    ...
    if L2_2 then
        ...
        if L3_2 then
            ...
            if "string" == L3_2 then
                ...
                Config.FrameworkFunctions.Notify("Telefonun Yok!")
                L3_2 = type
                L4_2 = Config
                L4_2 = L4_2.PhoneItem
                L3_2 = L3_2(L4_2)
            ...
            L4_2 = true
            L3_2(L4_2)
            TriggerClientEvent("QBCore:Notify", src, "Telefonun Yok!")
        end
    else
        L3_2 = A1_2
        L4_2 = false
