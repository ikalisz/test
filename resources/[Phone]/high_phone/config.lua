...
Config.PhoneItem = "white_phone" -- Phone item spawn name, can be a table: {"phone1", "phone2"}
Config.AllowUsageInWater = true -- Set to true if you want to allow opening the phone in water. [The camera might be buggy]
...
Config.MailFormat = "@mail.com" -- Email address format [suffix]
...
Config.UseHigh3D = true -- Use resource high_3dsounds? If false, will automatically use xSound. For best experience use Highrider-3DSounds
...
Config.TwitterRanks = {
    ...
    ["verified"] = {
        label = "Approved", -- What will show up when hovered on the icon?
...
Config.AdsCategories = {
    ...
    [1] = { -- DO NOT CHANGE THIS CATEGORY JOB NAME, THIS IS THE DEFAULT/MAIN CATEGORY
        ...
        info = { -- Detailed information of the category
            title = "All ads",
            description = "All job advertisements and individual ads"
        },
    ...
    [2] = {
        ...
        info = { -- Detailed information of the category
            title = "PD ads",
            description = "You can see all PD ads"
        }
    },
    [3] = { 
        ...
        job = {"burger", "hotdog"},
        jobGrade = 0, -- People with this or higher job grade will post all ads to this category.
        icon = "media/icons/burger.png", -- Icon of the category button
        color = "#8d3f00", -- RGBA or hex code
        info = { -- Detailed information of the category
            title = "Restaurant ads",
            description = "youCanSeeAllRestaurantAds"
        }
    },
    [4] = {
        label = "Mechanic", -- Category label
        job = {"mechanic", "bennys_mechanic", "mechanic_ottos", "mechanic_tunner", "mechanic_hayes"}, -- People with this job name will post all ads to this category.
        jobGrade = 0, -- People with this or higher job grade will post all ads to this category.
        icon = "media/icons/servicecar.png", -- Icon of the category button
        color = "#525252", -- RGBA or hex code
        info = { -- Detailed information of the category
            title = "Service ads",
            description = "You can see all service ads"
        }
    }
}