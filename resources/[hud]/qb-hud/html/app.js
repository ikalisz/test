...
const app = Vue.createApp({
    data: function() {
        return {
            ...
            isToggleProgbarShapeChecked: this.initIsToggleProgbarShapeChecked(),
            isToggleNotifyShapeChecked: this.initIsToggleNotifyShapeChecked(),
    ...
    watch: {
        ...
        isToggleProgbarShapeChecked: function() {
            localStorage.setItem("isToggleProgbarShapeChecked", this.isToggleProgbarShapeChecked);
        },
        isToggleNotifyShapeChecked: function() {
            localStorage.setItem("isToggleNotifyShapeChecked", this.isToggleNotifyShapeChecked);
        },
    ...
    methods: {
        ...
        initIsToggleProgbarShapeChecked: function() {
            const stored = localStorage.getItem("isToggleProgbarShapeChecked");
            if (stored === null) {
                return 'yuvarlak';
            } else {
                return stored;
        ...
        initIsToggleNotifyShapeChecked: function() {
            const stored = localStorage.getItem("isToggleNotifyShapeChecked");
            if (stored === null) {
                return 'ikonlu';
            } else {
                return stored;
        ...
        ToggleProgbarShape: function(event) {
            targetId = event.currentTarget.id;
            ToggleProgbarShape()
        },
        ToggleNotifyShape: function(event) {
            targetId = event.currentTarget.id;
            ToggleNotifyShape()
        },
    ...
    mounted() {
        this.listener = window.addEventListener("message", (event) => {
            if (event.data.event === 'isToggleMapShapeChecked' || event.data.event === 'isChangeFPSChecked' || event.data.event === 'isToggleProgbarShapeChecked' || event.data.event === 'isToggleNotifyShapeChecked') {
...
function ToggleProgbarShape() {
    $.post('https://qb-hud/ToggleProgbarShape');
}
function ToggleNotifyShape() {
    $.post('https://qb-hud/ToggleNotifyShape');
}
...
const playerHud = {
    ...
    methods: {
        hudTick(data) {
            ...
            if (healtDusuk) {
                $("i.healt").addClass("danger")
                $("i.healt.danger").css("--color", this.healthColor)
            } else {
                $("i.healt.danger").removeClass("danger")
            }
            ...
            var armorDusuk = false;
            if (data.armor <= 0) {
                this.armorColor = "#740000";
            } else if (data.armor <= 40) {
            ...
            if (armorDusuk) {
                $("i.armor").addClass("danger")
                $("i.armor.danger").css("--color", this.armorColor)
            } else {
                $("i.armor.danger").removeClass("danger")
            }
            ...
            if (yemekDusuk) {
                $("i.yemek").addClass("danger")
                $("i.yemek.danger").css("--color", this.hungerColor)
            } else {
                $("i.yemek.danger").removeClass("danger")
            }
            ...
            if (suDusuk) {
                $("i.su").addClass("danger")
                $("i.su.danger").css("--color", this.thirstColor)
            } else {
                $("i.su.danger").removeClass("danger")
            }
            ...
            if (motorDusuk) {
                $("i.motor").addClass("danger")
                $("i.motor.danger").css("--color", this.engineColor)
            } else {
                $("i.motor.danger").removeClass("danger")
            }
