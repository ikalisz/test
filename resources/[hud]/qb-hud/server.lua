...
QBCore.Commands.Add('cash', 'Show the amount of cash money', {}, false, function(source, _)
    local Player = QBCore.Functions.GetPlayer(source)
    local cashamount = Player.PlayerData.money.cash
    TriggerClientEvent('hud:client:ShowAccounts', source, 'cash', cashamount)
end)

QBCore.Commands.Add('bank', 'Show the amount of money in the bank..', {}, false, function(source, _)
    local Player = QBCore.Functions.GetPlayer(source)
