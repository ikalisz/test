...
Config.Languages = {
  ['en'] = {
    ...
    ['infoupdateavtext'] = "An update is available, get the latest version from: ~y~https://discord.gg/uRaaUPNKmd~w~",
    ['suggestions'] = "Suggestions?",
    ['suggestionsinfo'] = "~r~Emotes~s~ You can take help via discord for any feature/emote suggestions for. ✉️",
    ...
    ['sentrequestto'] = "Invitation ~y~ sent.",
    ...
    ['camera'] = "Press (G) to take a photo.",
    ['makeitrain'] = "Press (G) to rain money.",
    ['pee'] = "Hold down the (G) key to pee.",
    ['spraychamp'] = "Press and hold (G) for champagne spray",
    ['stun'] = "Press (G) to 'use' the stun gun.",
    ['vape'] = "Press (G) keys for electronic cigarette.",
    ['bound'] = "Connect ",
    ['to'] = "him-her-it",
    ['currentlyboundemotes'] = " Attached emotes:",
    ['notvalidkey'] = "not a correct key.",
    ['keybinds'] = "🔢 Shortcuts",
    ['keybindsinfo'] = "Use",
    ['searchemotes'] = "🔍 Search Animation",
    ['searchinputtitle'] = "Search:",
    ['searchmenudesc'] = "'results for ~r~%s~w~':",
    ['searchnoresult'] = "'No results were found for ~r~%s~w~'.",
    ['searchshifttofav'] = "Hold L-Shift and press enter to set it as a favourite.",
    ['searchcantsetfav'] = "Shared emoticons cannot be set as favourites.",
    ['invalidvariation'] = "Invalid texture variation. Current choices: %s"
  },
  ['fr'] = {
        ['emotes'] = 'Emotes',
