...
QBCore.Functions.CreateCallback("vehicleshop:getMoney", function(source,cb,price)
...
RegisterNetEvent('rn-vehicleshop:setVehicleOwned', function(vehicleData)
    ...
    MySQL.Async.insert('INSERT INTO owned_vehicles (citizenid, plate, vehicle, stored, carName) VALUES (?, ?, ?, ?, ?)',{Player.PlayerData.citizenid, vehicleData["plate"], json.encode(vehicleData), 0, vehicleData.carName})
end)
