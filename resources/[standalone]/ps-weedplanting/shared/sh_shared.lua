...
--- Items
Shared.MaleSeed = 'lowgrademaleseed'
Shared.FemaleSeed = 'lowgradefemaleseed'
Shared.FertilizerItem = 'lowgradefert'
Shared.WaterItem = 'water'
...
Shared.ClearOnStartup = false -- Clear dead plants on script start-up
Shared.ObjectZOffset = -0.1 -- Z-coord offset for WeedProps
Shared.FireTime = 15000
