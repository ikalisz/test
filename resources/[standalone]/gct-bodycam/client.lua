...
RegisterNetEvent('gct-bodycam:client:openCamera', function(src)
    ...
    exports['qb-ui']:showInteraction("[E] Get out of the camera", nil, "bodycik")
end)
...
function exitCam()
    ...
    exports['qb-ui']:hideInteraction("bodycik")
    targetPed = nil
    cam = nil
    opencam = false
end

RegisterCommand("bodycamfix", function()
    exitCam()
    QBCore.Functions.Notify('It is closed', 'error', 7500)
end)
