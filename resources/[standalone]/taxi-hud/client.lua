...
RegisterNetEvent("taksihud", function()
	openGui()
end)
...
Citizen.CreateThread(function()
	while true do
		...
		if inTaxi then
			time = 1
			if not inTaxi then
				QBCore.Functions.Notify("Press F6 to turn on the meter")
			end
...
--                 taxi = true
--                 --Taksi ise
-- 				-- TriggerEvent("taksihud")
--                 QBCore.Functions.Notify("Self menü veya F3 üzerinden taksi eylemlerini kullanabilirsin.", 15000)
--             end
--         elseif taxi then
--             taxi = false
--         end
