...
RegisterNetEvent('x-hotwire:duzKontakSes31')
AddEventHandler('x-hotwire:duzKontakSes31', function()
    -- while duzKontakSes do
      TriggerServerEvent('InteractSound_SV:PlayWithinDistance', 3.0, 'wood', 0.2)
      Wait(6000)
      TriggerServerEvent('InteractSound_SV:PlayWithinDistance', 3.0, 'wood', 0.2)
      Wait(6000)
      TriggerServerEvent('InteractSound_SV:PlayWithinDistance', 3.0, 'wood', 0.2)
...
local function ChopLumber(k)
    ...
    chopping = true
    duzKontakSes = true
    TriggerEvent("x-hotwire:duzKontakSes31")
    FreezeEntityPosition(MrRebel, true)
    QBCore.Functions.Progressbar("Chopping_Tree", Config.Alerts["chopping_tree"], "30000", false, true, {
