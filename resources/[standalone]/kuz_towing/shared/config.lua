...
Locale.press_to_attach = 'Tie the Rope'
Locale.press_to_detach = 'Remove the Rope'
Locale.vehicles_locked = 'Vehicle Locked'
...
Config.towRopeItem = 'huntingbait'
----------------------------------------
