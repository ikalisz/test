...
QBCore.Functions.CreateCallback('myDJ:requestPlaylistsAndSongs', function(source, cb)
    ...
    exports.oxmysql:execute('SELECT * from playlists', {},
    function(result)
        playlists = result

        exports.oxmysql:execute('SELECT * from playlist_songs', {},
        function(result)
            songs = result
            cb(playlists, songs)
        end
...
QBCore.Functions.CreateCallback('myDJ:requestPlaylistById', function(source, cb, playlistId)
	...
	exports.oxmysql:execute('SELECT * from playlist_songs WHERE playlist = @playlistId', {
...
QBCore.Functions.CreateCallback('myDJ:requestPlaylists', function(source, cb)
    exports.oxmysql:execute('SELECT id, label from playlists', {},
    function(result)
        cb(result)
    end
    )
...
QBCore.Functions.CreateCallback('myDJ:requestPlaylistSongs', function(source, cb, playlistId)
    exports.oxmysql:execute('SELECT * from playlist_songs WHERE playlist = @playlist', {
        ['@playlistId'] = playlistId,
    },
    function(result)
        cb(result)
