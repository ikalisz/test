...
RegisterNetEvent('hover-chairs:Chair1')
AddEventHandler('hover-chairs:Chair1', function()
	greenchair()
	QBCore.Functions.Notify('Chair Used, use the chair again to get up.',  7500)
end)

RegisterNetEvent('hover-chairs:Chair2')
AddEventHandler('hover-chairs:Chair2', function()
	QBCore.Functions.Notify('Chair Used, use the chair again to get up.',  7500)
	pladchair()
end)
...
RegisterCommand('chairfix', function()
	FreezeEntityPosition(PlayerPedId(),false)
	removeAttachedProp()
	removeAttachedProp2()
end)
