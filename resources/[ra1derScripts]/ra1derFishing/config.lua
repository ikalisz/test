...
Config.FishingWaitTime = {minTime = 17500, maxTime = 28500}     -- How long a player will be waiting to fish, during or after casting fishingrod
...
Config.Skillbar = "tgiann-skillbar"                             	-- Must choose one of the avalible skillbars ["reload-skillbar","np-skillbar","qb-skillbar"]
...
Config.BoatSpawnLocation = {
    LaPuerta	= vector4(-1814.37, -1212.93, 13.017, 33.61),        
...
-- Rewards
Config.smallLootboxCash = 1000                                  	-- Price of the cash reward for the "Metal Box"                     -- Item reward besides the "Corroded Key"
...
Config.PedList = {                                              -- Peds that will be spawned in (if you change a ped model here you need to also change the ped model in client/addons.lua qb-target exports)
	...
	-- 	coords = vector3(-1814.37, -1212.93, 12.017),               
	-- 	heading = 34.8,
	-- 	gender = "male",
