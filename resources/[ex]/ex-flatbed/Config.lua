...
Config.Translation = { -- String | Translations
    ["LOWER"] = "~INPUT_CELLPHONE_DOWN~ Bed ~y~Down~s~",
    ["RAISE"] = "~INPUT_CELLPHONE_UP~ Bed ~y~Raise~s~",

    ["ATTACH"] = "~INPUT_DETONATE~ Bed ~g~Attach~s~",
    ["DETACH"] = "~INPUT_DETONATE~ Bed ~r~Deattach~s~ "
}