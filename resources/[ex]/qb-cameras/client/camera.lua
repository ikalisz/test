...
AddEventHandler('qb-cameras:client:UseCCTVCamera', function(is360, GcamID)
    QBCore.Functions.Progressbar("camerkit", "Opening the CCTV Camera Setup..", 3000, false, true, {
        ...
        if dialog ~= nil then
            ...
            --if dialog.cameraid ~= nil then 
                QBCore.Functions.TriggerCallback('QBCore:HasItem', function(hasItem)
                    if hasItem then 
                        QBCore.Functions.Progressbar("fixing camera", "Installing CCTV ..", 2000, false, true, {
                            disableMovement = true,
                            disableCarMovement = true,
                            disableMouse = false,
                            disableCombat = true,
                            ...
                            exports['qb-target']:AddEntityZone("camera-"..GcamID, cam, {
                                ...
                                options = {
                                    ...
                                    },
                                    {
                                        ...
                                        icon = "fa fa-camera",
                                        label = "Disconnect and Close Camera",
                                        camera = GcamID,
                                        ent = cam,
                                    },
                                },
                        ...
                        QBCore.Functions.Notify("You do not have the Required Item. Stop Exploiting KEKK!", "error", 5000)
                    end
                end, itemname)
            --end
        end
